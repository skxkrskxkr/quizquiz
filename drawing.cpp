...
int main(void)
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		{
			drawLine(10 + a, 510, 250+ a, 750, 255, 0, 0);
		}

		drawcircle(800, 250, 100, 255, 0, 0);

		emptylect(300, 900, 200, 200, 255, 0, 0);

		for (int a = 750; a < 950; a++)      // lect
			for (int b = 750; b < 950; b++)
			{
				drawPixel(b, a, 255, 0, 0);
			}

		drawLine(50, 50, 150, 150, 255, 0, 0);  // triangle
		drawLine(150, 150, 250, 50, 25, 0, 0);
		for (int a = 50; a < 250; a++)
		{
			drawPixel(a, 50, 255, 0, 0);
		}

		drawLine(350, 350, 450, 430, 255, 0, 0); // pentagon
		drawLine(450, 430, 550, 350, 255, 0, 0);
		drawLine(350, 350, 400, 250, 255, 0, 0);
		drawLine(500, 250, 550, 350, 255, 0, 0);
		for (int a = 400; a < 500; a++)
		{
			drawPixel(a, 250, 255, 0, 0);
		}
